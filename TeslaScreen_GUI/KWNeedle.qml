...
Canvas {
    ...
    onValueChanged: {
        zeiger.rotation = Math.min(Math.max(10, canvas.value*3.5 - 90), 90); canvas.currentValue = zeiger.rotation - 90
    }
    ...
    Rectangle {
        ...
        color: "#FFC73E"
        onRotationChanged: {
            canvas.currentValue = zeiger.rotation - 90; canvas.requestPaint()}
